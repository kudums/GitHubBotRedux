  ...
  (function () {
    ...
    Carousel._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        let _config = _extends({}, Default, $$$1(this).data());
    ...
    Carousel._dataApiClickHandler = function _dataApiClickHandler(event) {
      ...
      const config = _extends({}, $$$1(target).data(), $$$1(this).data());
  ...
  (function () {
    ...
    Collapse._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        const _config = _extends({}, Default, $this.data(), typeof config === 'object' && config);
 ...
 */
  ...
  (function () {
    ...
    Modal._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        const _config = _extends({}, Modal.Default, $$$1(this).data(), typeof config === 'object' && config);
   ...
   */
    ...
    $$$1(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
      ...
      const config = $$$1(target).data(DATA_KEY) ? 'toggle' : _extends({}, $$$1(target).data(), $$$1(this).data());
 ...
 */
   ...
   */
    ...
    const BSCLS_PREFIX_REGEX = new RegExp(`(^|\\s)${CLASS_PREFIX}\\S+`, 'g');
    const Default = _extends({}, Tooltip.Default, {
      placement: 'right',
      trigger: 'click',
      content: '',
      template: '<div class="popover" role="tooltip">' + '<div class="arrow"></div>' + '<h3 class="popover-header"></h3>' + '<div class="popover-body"></div></div>',
    });
    const DefaultType = _extends({}, Tooltip.DefaultType, {
