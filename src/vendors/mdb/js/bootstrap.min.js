  ...
  function i(t, e) { for (let n = 0; n < e.length; n++) { const i = e[n]; i.enumerable = i.enumerable || !1, i.configurable = !0, 'value' in i && (i.writable = !0), Object.defineProperty(t, i.key, i); } } function s(t, e, n) { return e && i(t.prototype, e), n && i(t, n), t; } function r() { return (r = Object.assign || function (t) { for (let e = 1; e < arguments.length; e++) { const n = arguments[e]; for (const i in n)Object.prototype.hasOwnProperty.call(n, i) && (t[i] = n[i]); } return t; }).apply(this, arguments); }e = e && e.hasOwnProperty('default') ? e.default : e, n = n && n.hasOwnProperty('default') ? n.default : n; let o,
    ...
    P = (function (t) {
      let e = !1; function n(e) {
        let n = this,
          s = !1; return t(this).one(i.TRANSITION_END, () => { s = !0; }), setTimeout(() => { s || i.triggerTransitionEnd(n); }, e), this;
      } var i = {
        TRANSITION_END: 'bsTransitionEnd',
        getUID(t) { do { t += ~~(1e6 * Math.random()); } while (document.getElementById(t));return t; },
        getSelectorFromElement(e) {
          let n,
            i = e.getAttribute('data-target'); i && i !== '#' || (i = e.getAttribute('href') || ''), i.charAt(0) === '#' && (n = i, i = n = typeof t.escapeSelector === 'function' ? t.escapeSelector(n).substr(1) : n.replace(/(:|\.|\[|\]|,|=|@)/g, '\\$1')); try { return t(document).find(i).length > 0 ? i : null; } catch (t) { return null; }
        },
        reflow(t) { return t.offsetHeight; },
        triggerTransitionEnd(n) { t(n).trigger(e.end); },
    ...
    L = (a = 'alert', h = `.${l = 'bs.alert'}`, c = (o = e).fn[a], u = { CLOSE: `close${h}`, CLOSED: `closed${h}`, CLICK_DATA_API: `click${h}.data-api` }, f = 'alert', d = 'fade', _ = 'show', g = (function () {
      function t(t) { this._element = t; } const e = t.prototype; return e.close = function (t) { t = t || this._element; const e = this._getRootElement(t); this._triggerCloseEvent(e).isDefaultPrevented() || this._removeElement(e); }, e.dispose = function () { o.removeData(this._element, l), this._element = null; }, e._getRootElement = function (t) {
        let e = P.getSelectorFromElement(t),
          n = !1; return e && (n = o(e)[0]), n || (n = o(t).closest(`.${f}`)[0]), n;
      }, e._triggerCloseEvent = function (t) { const e = o.Event(u.CLOSE); return o(t).trigger(e), e; }, e._removeElement = function (t) { const e = this; o(t).removeClass(_), P.supportsTransitionEnd() && o(t).hasClass(d) ? o(t).one(P.TRANSITION_END, n => e._destroyElement(t, n)).emulateTransitionEnd(150) : this._destroyElement(t); }, e._destroyElement = function (t) { o(t).detach().trigger(u.CLOSED).remove(); }, t._jQueryInterface = function (e) {
        return this.each(function () {
          let n = o(this),
            i = n.data(l); i || (i = new t(this), n.data(l, i)), e === 'close' && i[e](this);
        });
      }, t._handleDismiss = function (t) { return function (e) { e && e.preventDefault(), t.close(this); }; }, s(t, null, [{ key: 'VERSION', get() { return '4.0.0'; } }]), t;
    ...
    R = (m = 'button', E = `.${v = 'bs.button'}`, T = '.data-api', y = (p = e).fn[m], C = 'active', I = 'btn', A = 'focus', b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = 'input', w = '.active', N = '.btn', O = { CLICK_DATA_API: `click${E}${T}`, FOCUS_BLUR_DATA_API: `focus${E}${T} blur${E}${T}` }, k = (function () {
      function t(t) { this._element = t; } const e = t.prototype; return e.toggle = function () {
        let t = !0,
          e = !0,
          n = p(this._element).closest(D)[0]; if (n) { const i = p(this._element).find(S)[0]; if (i) { if (i.type === 'radio') if (i.checked && p(this._element).hasClass(C))t = !1; else { const s = p(n).find(w)[0]; s && p(s).removeClass(C); } if (t) { if (i.hasAttribute('disabled') || n.hasAttribute('disabled') || i.classList.contains('disabled') || n.classList.contains('disabled')) return; i.checked = !p(this._element).hasClass(C), p(i).trigger('change'); }i.focus(), e = !1; } }e && this._element.setAttribute('aria-pressed', !p(this._element).hasClass(C)), t && p(this._element).toggleClass(C);
      }, e.dispose = function () { p.removeData(this._element, v), this._element = null; }, t._jQueryInterface = function (e) { return this.each(function () { let n = p(this).data(v); n || (n = new t(this), p(this).data(v, n)), e === 'toggle' && n[e](); }); }, s(t, null, [{ key: 'VERSION', get() { return '4.0.0'; } }]), t;
    }()), p(document).on(O.CLICK_DATA_API, b, (t) => { t.preventDefault(); let e = t.target; p(e).hasClass(I) || (e = p(e).closest(N)), k._jQueryInterface.call(p(e), 'toggle'); }).on(O.FOCUS_BLUR_DATA_API, b, (t) => { const e = p(t.target).closest(N)[0]; p(e).toggleClass(A, /^focus(in)?$/.test(t.type)); }), p.fn[m] = k._jQueryInterface, p.fn[m].Constructor = k, p.fn[m].noConflict = function () { return p.fn[m] = y, k._jQueryInterface; }, k),
    j = (function (t) {
      let e = 'carousel',
        n = 'bs.carousel',
        i = `.${n}`,
        ...
        C = (function () {
          function o(e, n) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(n), this._element = t(e)[0], this._indicatorsElement = t(this._element).find(y.INDICATORS)[0], this._addEventListeners(); } const C = o.prototype; return C.next = function () { this._isSliding || this._slide(h); }, C.nextWhenVisible = function () { !document.hidden && t(this._element).is(':visible') && t(this._element).css('visibility') !== 'hidden' && this.next(); }, C.prev = function () { this._isSliding || this._slide(c); }, C.pause = function (e) { e || (this._isPaused = !0), t(this._element).find(y.NEXT_PREV)[0] && P.supportsTransitionEnd() && (P.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null; }, C.cycle = function (t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)); }, C.to = function (e) { const n = this; this._activeElement = t(this._element).find(y.ACTIVE_ITEM)[0]; const i = this._getItemIndex(this._activeElement); if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding)t(this._element).one(d.SLID, () => n.to(e)); else { if (i === e) return this.pause(), void this.cycle(); const s = e > i ? h : c; this._slide(s, this._items[e]); } }, C.dispose = function () { t(this._element).off(i), t.removeData(this._element, n), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null; }, C._getConfig = function (t) { return t = r({}, a, t), P.typeCheckConfig(e, t, l), t; }, C._addEventListeners = function () { const e = this; this._config.keyboard && t(this._element).on(d.KEYDOWN, t => e._keydown(t)), this._config.pause === 'hover' && (t(this._element).on(d.MOUSEENTER, t => e.pause(t)).on(d.MOUSELEAVE, t => e.cycle(t)), 'ontouchstart' in document.documentElement && t(this._element).on(d.TOUCHEND, () => { e.pause(), e.touchTimeout && clearTimeout(e.touchTimeout), e.touchTimeout = setTimeout(t => e.cycle(t), 500 + e._config.interval); })); }, C._keydown = function (t) { if (!/input|textarea/i.test(t.target.tagName)) switch (t.which) { case 37: t.preventDefault(), this.prev(); break; case 39: t.preventDefault(), this.next(); } }, C._getItemIndex = function (e) { return this._items = t.makeArray(t(e).parent().find(y.ITEM)), this._items.indexOf(e); }, C._getItemByDirection = function (t, e) {
            ...
            return this.each(function () {
              let i = t(this).data(n),
                s = r({}, a, t(this).data()); typeof e === 'object' && (s = r({}, s, e)); const l = typeof e === 'string' ? e : s.slide; if (i || (i = new o(this, s), t(this).data(n, i)), typeof e === 'number')i.to(e); else if (typeof l === 'string') { if (typeof i[l] === 'undefined') throw new TypeError(`No method named "${l}"`); i[l](); } else s.interval && (i.pause(), i.cycle());
            });
          }, o._dataApiClickHandler = function (e) {
            const i = P.getSelectorFromElement(this); if (i) {
              const s = t(i)[0]; if (s && t(s).hasClass(_)) {
          ...
          }, s(o, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return a; } }]), o;
    ...
    H = (function (t) {
      let e = 'collapse',
        ...
        m = (function () {
          function i(e, n) {
            this._isTransitioning = !1, this._element = e, this._config = this._getConfig(n), this._triggerArray = t.makeArray(t(`[data-toggle="collapse"][href="#${e.id}"],[data-toggle="collapse"][data-target="#${e.id}"]`)); for (let i = t(p.DATA_TOGGLE), s = 0; s < i.length; s++) {
              let r = i[s],
                o = P.getSelectorFromElement(r); o !== null && t(o).filter(e).length > 0 && (this._selector = o, this._triggerArray.push(r));
            } this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle();
          } const o = i.prototype; return o.toggle = function () { t(this._element).hasClass(c) ? this.hide() : this.show(); }, o.show = function () {
            let e,
              s,
              r = this; if (!this._isTransitioning && !t(this._element).hasClass(c) && (this._parent && (e = t.makeArray(t(this._parent).find(p.ACTIVES).filter(`[data-parent="${this._config.parent}"]`))).length === 0 && (e = null), !(e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) { const o = t.Event(h.SHOW); if (t(this._element).trigger(o), !o.isDefaultPrevented()) { e && (i._jQueryInterface.call(t(e).not(this._selector), 'hide'), s || t(e).data(n, null)); const a = this._getDimension(); t(this._element).removeClass(u).addClass(f), this._element.style[a] = 0, this._triggerArray.length > 0 && t(this._triggerArray).removeClass(d).attr('aria-expanded', !0), this.setTransitioning(!0); const l = function () { t(r._element).removeClass(f).addClass(u).addClass(c), r._element.style[a] = '', r.setTransitioning(!1), t(r._element).trigger(h.SHOWN); }; if (P.supportsTransitionEnd()) { const _ = `scroll${a[0].toUpperCase() + a.slice(1)}`; t(this._element).one(P.TRANSITION_END, l).emulateTransitionEnd(600), this._element.style[a] = `${this._element[_]}px`; } else l(); } }
          }, o.hide = function () {
            const e = this; if (!this._isTransitioning && t(this._element).hasClass(c)) {
              const n = t.Event(h.HIDE); if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                const i = this._getDimension(); if (this._element.style[i] = `${this._element.getBoundingClientRect()[i]}px`, P.reflow(this._element), t(this._element).addClass(f).removeClass(u).removeClass(c), this._triggerArray.length > 0) {
                  for (let s = 0; s < this._triggerArray.length; s++) {
                    let r = this._triggerArray[s],
                      o = P.getSelectorFromElement(r); if (o !== null)t(o).hasClass(c) || t(r).addClass(d).attr('aria-expanded', !1);
                  }
                } this.setTransitioning(!0); const a = function () { e.setTransitioning(!1), t(e._element).removeClass(f).addClass(u).trigger(h.HIDDEN); }; this._element.style[i] = '', P.supportsTransitionEnd() ? t(this._element).one(P.TRANSITION_END, a).emulateTransitionEnd(600) : a();
              }
            }
            ...
            let e = this,
              n = null; P.isElement(this._config.parent) ? (n = this._config.parent, typeof this._config.parent.jquery !== 'undefined' && (n = this._config.parent[0])) : n = t(this._config.parent)[0]; const s = `[data-toggle="collapse"][data-parent="${this._config.parent}"]`; return t(n).find(s).each((t, n) => { e._addAriaAndCollapsedClass(i._getTargetFromElement(n), [n]); }), n;
          }, o._addAriaAndCollapsedClass = function (e, n) { if (e) { const i = t(e).hasClass(c); n.length > 0 && t(n).toggleClass(d, !i).attr('aria-expanded', i); } }, i._getTargetFromElement = function (e) { const n = P.getSelectorFromElement(e); return n ? t(n)[0] : null; }, i._jQueryInterface = function (e) {
            return this.each(function () {
              let s = t(this),
                o = s.data(n),
                l = r({}, a, s.data(), typeof e === 'object' && e); if (!o && l.toggle && /show|hide/.test(e) && (l.toggle = !1), o || (o = new i(this, l), s.data(n, o)), typeof e === 'string') { if (typeof o[e] === 'undefined') throw new TypeError(`No method named "${e}"`); o[e](); }
            });
          }, s(i, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return a; } }]), i;
    ...
    W = (function (t) {
      let e = 'dropdown',
        ...
        L = (function () {
          function a(t, e) { this._element = t, this._popper = null, this._config = this._getConfig(e), this._menu = this._getMenuElement(), this._inNavbar = this._detectNavbar(), this._addEventListeners(); } const l = a.prototype; return l.toggle = function () {
            ...
            let t = this,
              e = {}; return typeof this._config.offset === 'function' ? e.fn = function (e) { return e.offsets = r({}, e.offsets, t._config.offset(e.offsets) || {}), e; } : e.offset = this._config.offset, { placement: this._getPlacement(), modifiers: { offset: e, flip: { enabled: this._config.flip }, preventOverflow: { boundariesElement: this._config.boundary } } };
          }, a._jQueryInterface = function (e) { return this.each(function () { let n = t(this).data(i); if (n || (n = new a(this, typeof e === 'object' ? e : null), t(this).data(i, n)), typeof e === 'string') { if (typeof n[e] === 'undefined') throw new TypeError(`No method named "${e}"`); n[e](); } }); }, a._clearMenus = function (e) {
            if (!e || e.which !== 3 && (e.type !== 'keyup' || e.which === 9)) {
              for (let n = t.makeArray(t(E)), s = 0; s < n.length; s++) {
                let r = a._getParentFromElement(n[s]),
                  o = t(n[s]).data(i),
                  l = { relatedTarget: n[s] }; if (o) { const h = o._menu; if (t(r).hasClass(f) && !(e && (e.type === 'click' && /input|textarea/i.test(e.target.tagName) || e.type === 'keyup' && e.which === 9) && t.contains(r, e.target))) { const u = t.Event(c.HIDE, l); t(r).trigger(u), u.isDefaultPrevented() || ('ontouchstart' in document.documentElement && t('body').children().off('mouseover', null, t.noop), n[s].setAttribute('aria-expanded', 'false'), t(h).removeClass(f), t(r).removeClass(f).trigger(t.Event(c.HIDDEN, l))); } }
              }
            }
            ...
            if ((/input|textarea/i.test(e.target.tagName) ? !(e.which === 32 || e.which !== 27 && (e.which !== 40 && e.which !== 38 || t(e.target).closest(y).length)) : h.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !t(this).hasClass(u))) {
              let n = a._getParentFromElement(this),
                i = t(n).hasClass(f); if ((i || e.which === 27 && e.which === 32) && (!i || e.which !== 27 && e.which !== 32)) { const s = t(n).find(I).get(); if (s.length !== 0) { let r = s.indexOf(e.target); e.which === 38 && r > 0 && r--, e.which === 40 && r < s.length - 1 && r++, r < 0 && (r = 0), s[r].focus(); } } else { if (e.which === 27) { const o = t(n).find(E)[0]; t(o).trigger('focus'); }t(this).trigger('click'); }
            }
          }, s(a, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return O; } }, { key: 'DefaultType', get() { return k; } }]), a;
    ...
    M = (function (t) {
      let e = 'modal',
        ...
        p = (function () {
          ...
          }, p._resetScrollbar = function () { t(g.FIXED_CONTENT).each((e, n) => { const i = t(n).data('padding-right'); typeof i !== 'undefined' && t(n).css('padding-right', i).removeData('padding-right'); }), t(`${g.STICKY_CONTENT}, ${g.NAVBAR_TOGGLER}`).each((e, n) => { const i = t(n).data('margin-right'); typeof i !== 'undefined' && t(n).css('margin-right', i).removeData('margin-right'); }); const e = t('body').data('padding-right'); typeof e !== 'undefined' && t('body').css('padding-right', e).removeData('padding-right'); }, p._getScrollbarWidth = function () { const t = document.createElement('div'); t.className = c, document.body.appendChild(t); const e = t.getBoundingClientRect().width - t.clientWidth; return document.body.removeChild(t), e; }, o._jQueryInterface = function (e, i) {
            return this.each(function () {
              let s = t(this).data(n),
                a = r({}, o.Default, t(this).data(), typeof e === 'object' && e); if (s || (s = new o(this, a), t(this).data(n, s)), typeof e === 'string') { if (typeof s[e] === 'undefined') throw new TypeError(`No method named "${e}"`); s[e](i); } else a.show && s.show(i);
            });
          }, s(o, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return a; } }]), o;
        }()); return t(document).on(h.CLICK_DATA_API, g.DATA_TOGGLE, function (e) {
        let i,
          s = this,
          o = P.getSelectorFromElement(this); o && (i = t(o)[0]); const a = t(i).data(n) ? 'toggle' : r({}, t(i).data(), t(this).data()); this.tagName !== 'A' && this.tagName !== 'AREA' || e.preventDefault(); var l = t(i).one(h.SHOW, (e) => { e.isDefaultPrevented() || l.one(h.HIDDEN, () => { t(s).is(':visible') && s.focus(); }); }); p._jQueryInterface.call(t(i), a, this);
        ...
        I = (function () {
          function a(t, e) { if (typeof n === 'undefined') throw new TypeError('Bootstrap tooltips require Popper.js (https://popper.js.org)'); this._isEnabled = !0, this._timeout = 0, this._hoverState = '', this._activeTrigger = {}, this._popper = null, this.element = t, this.config = this._getConfig(e), this.tip = null, this._setListeners(); } const I = a.prototype; return I.enable = function () { this._isEnabled = !0; }, I.disable = function () { this._isEnabled = !1; }, I.toggleEnabled = function () { this._isEnabled = !this._isEnabled; }, I.toggle = function (e) {
            ...
            const e = this; if (t(this.element).css('display') === 'none') throw new Error('Please use show on visible elements'); const i = t.Event(this.constructor.Event.SHOW); if (this.isWithContent() && this._isEnabled) {
              t(this.element).trigger(i); const s = t.contains(this.element.ownerDocument.documentElement, this.element); if (i.isDefaultPrevented() || !s) return; let r = this.getTipElement(),
                o = P.getUID(this.constructor.NAME); r.setAttribute('id', o), this.element.setAttribute('aria-describedby', o), this.setContent(), this.config.animation && t(r).addClass(g); let l = typeof this.config.placement === 'function' ? this.config.placement.call(this, r, this.element) : this.config.placement,
            ...
            let e = this.getTipElement(),
              n = this.config.animation; e.getAttribute('x-placement') === null && (t(e).removeClass(g), this.config.animation = !1, this.hide(), this.show(), this.config.animation = n);
          }, a._jQueryInterface = function (e) {
            return this.each(function () {
              let n = t(this).data(i),
                s = typeof e === 'object' && e; if ((n || !/dispose|hide/.test(e)) && (n || (n = new a(this, s), t(this).data(i, n)), typeof e === 'string')) { if (typeof n[e] === 'undefined') throw new TypeError(`No method named "${e}"`); n[e](); }
            });
          }, s(a, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return u; } }, { key: 'NAME', get() { return e; } }, { key: 'DATA_KEY', get() { return i; } }, { key: 'Event', get() { return _; } }, { key: 'EVENT_KEY', get() { return o; } }, { key: 'DefaultType', get() { return h; } }]), a;
    ...
    x = (function (t) {
      let e = 'popover',
        ...
        g = (function (r) {
          let o,
            g; function p() { return r.apply(this, arguments) || this; }g = r, (o = p).prototype = Object.create(g.prototype), o.prototype.constructor = o, o.__proto__ = g; const m = p.prototype; return m.isWithContent = function () { return this.getTitle() || this._getContent(); }, m.addAttachmentClass = function (e) { t(this.getTipElement()).addClass(`bs-popover-${e}`); }, m.getTipElement = function () { return this.tip = this.tip || t(this.config.template)[0], this.tip; }, m.setContent = function () { const e = t(this.getTipElement()); this.setElementContent(e.find(f), this.getTitle()); let n = this._getContent(); typeof n === 'function' && (n = n.call(this.element)), this.setElementContent(e.find(d), n), e.removeClass(`${c} ${u}`); }, m._getContent = function () { return this.element.getAttribute('data-content') || this.config.content; }, m._cleanTipClass = function () {
            let e = t(this.getTipElement()),
              n = e.attr('class').match(a); n !== null && n.length > 0 && e.removeClass(n.join(''));
          }, p._jQueryInterface = function (e) {
            return this.each(function () {
              let i = t(this).data(n),
                s = typeof e === 'object' ? e : null; if ((i || !/destroy|hide/.test(e)) && (i || (i = new p(this, s), t(this).data(n, i)), typeof e === 'string')) { if (typeof i[e] === 'undefined') throw new TypeError(`No method named "${e}"`); i[e](); }
            });
          }, s(p, null, [{ key: 'VERSION', get() { return '4.0.0'; } }, { key: 'Default', get() { return l; } }, { key: 'NAME', get() { return e; } }, { key: 'DATA_KEY', get() { return n; } }, { key: 'Event', get() { return _; } }, { key: 'EVENT_KEY', get() { return i; } }, { key: 'DefaultType', get() { return h; } }]), p;
        ...
        g = (function () {
          function o(e, n) { const i = this; this._element = e, this._scrollElement = e.tagName === 'BODY' ? window : e, this._config = this._getConfig(n), this._selector = `${this._config.target} ${f.NAV_LINKS},${this._config.target} ${f.LIST_ITEMS},${this._config.target} ${f.DROPDOWN_ITEMS}`, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(h.SCROLL, t => i._process(t)), this.refresh(), this._process(); } const g = o.prototype; return g.refresh = function () {
            let e = this,
              ...
              s = i === _ ? this._getScrollTop() : 0; this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), t.makeArray(t(this._selector)).map((e) => {
              let n,
                r = P.getSelectorFromElement(e); if (r && (n = t(r)[0]), n) { const o = n.getBoundingClientRect(); if (o.width || o.height) return [t(n)[i]().top + s, r]; } return null;
    ...
    V = (function (t) {
      let e = 'bs.tab',
        ...
        v = (function () {
          function n(t) { this._element = t; } const i = n.prototype; return i.show = function () {
            const e = this; if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(a) || t(this._element).hasClass(l))) {
              let n,
                i,
                s = t(this._element).closest(f)[0],
                o = P.getSelectorFromElement(this._element); if (s) { const h = s.nodeName === 'UL' ? _ : d; i = (i = t.makeArray(t(s).find(h)))[i.length - 1]; } let c = t.Event(r.HIDE, { relatedTarget: this._element }),
                u = t.Event(r.SHOW, { relatedTarget: i }); if (i && t(i).trigger(c), t(this._element).trigger(u), !u.isDefaultPrevented() && !c.isDefaultPrevented()) {
                o && (n = t(o)[0]), this._activate(this._element, s); const g = function () {
            ...
            let s = this,
              ...
              a = function () { return s._transitionComplete(e, r, i); }; r && o ? t(r).one(P.TRANSITION_END, a).emulateTransitionEnd(150) : a();
          }, i._transitionComplete = function (e, n, i) { if (n) { t(n).removeClass(`${c} ${a}`); const s = t(n.parentNode).find(m)[0]; s && t(s).removeClass(a), n.getAttribute('role') === 'tab' && n.setAttribute('aria-selected', !1); } if (t(e).addClass(a), e.getAttribute('role') === 'tab' && e.setAttribute('aria-selected', !0), P.reflow(e), t(e).addClass(c), e.parentNode && t(e.parentNode).hasClass(o)) { const r = t(e).closest(u)[0]; r && t(r).find(p).addClass(a), e.setAttribute('aria-expanded', !0); }i && i(); }, n._jQueryInterface = function (i) {
            return this.each(function () {
              let s = t(this),
                r = s.data(e); if (r || (r = new n(this), s.data(e, r)), typeof i === 'string') { if (typeof r[i] === 'undefined') throw new TypeError(`No method named "${i}"`); r[i](); }
            });
          }, s(n, null, [{ key: 'VERSION', get() { return '4.0.0'; } }]), n;
